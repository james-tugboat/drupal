...
function newsplus_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['mtt_settings']['google_map_tab']['google_map'] = array(
    '#type' => 'details',
    '#title' => t('Google Maps'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  ...
  $form['mtt_settings']['google_map_tab']['google_map']['google_map_contact'] = array(
    '#type' => 'fieldset',
  ...
  $form['mtt_settings']['google_map_tab']['google_map']['google_map_contact']['google_map_latitude'] = array(
    '#type' => 'textfield',
  ...
  $form['mtt_settings']['google_map_tab']['google_map']['google_map_contact']['google_map_longitude'] = array(
    '#type' => 'textfield',
  ...
  $form['mtt_settings']['google_map_tab']['google_map']['google_map_contact']['google_map_zoom'] = array(
    '#type' => 'textfield',
  ...
  $form['mtt_settings']['google_map_tab']['google_map']['google_map_contact']['google_map_canvas'] = array(
    '#type' => 'textfield',
    '#title' => t('Google Maps Canvas CSS Class'),
    '#description'   => t('Set the Google Map Canvas CSS Class. For example: map-canvas'),
